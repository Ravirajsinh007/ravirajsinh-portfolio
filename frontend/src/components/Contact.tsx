...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 px-6 relative z-10 w-full max-w-6xl mx-auto pb-40">
      {/* Headings */}
      <div className="flex flex-col items-center md:items-start gap-4 mb-16 text-center md:text-left">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-950/45 border border-blue-900/35 text-[10px] font-mono font-bold uppercase text-blue-400 tracking-widest select-none">
          <MessageSquareText size={12} className="text-blue-400 animate-pulse" />
