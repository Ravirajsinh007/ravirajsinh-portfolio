...
export default function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  const sampleLogs = [
    "Initializing high-performance core...",
    "Loading secure visual telemetry...",
    "Compiling shaders & presentation buffers...",
    "Optimizing memory and asset allocations...",
    "Parsing Raviraj's professional resume matrix...",
    "Assembling highly responsive components...",
    "Establishing secure REST API gateways...",
    "Ready to deploy high-integrity dashboard."
  ];
